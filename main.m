%**************************************************************************
% Description: Variance difference analysis and validation for a network
% Input: (1) mask_ind.mat: index for in-brain voxels, including mask_ind.
%        (2) sm_EBM_*.mat: saptial maps for network * by EBM with component selection, 
%            phase processing and best-run seletction,including half_ind and Sm.
%        (3) bs_*.mat: bootstrap samples for network *, including bs_diff, bs_diff_FDR, bs_mag_diff and bs_mag_diff_FDR.
%        (4) intra_inter_*.mat: resampling results for intra- and inter- difference in network *, 
...
% Output: variance difference of SZ-HC on spatial source phase and magnitude in network *
...
% Note: details of resampling techniques are shown in data_validation.m
...
sub_networks = {'PCC','IPL', 'ACC'};  % sub-networks of DMN
location = [89,70,85];  % slice coordinates for SMdisplay.m
...
load data\sm_EBM_DMN.mat 
load data\bs_DMN.mat
load data\intra_inter_DMN.mat 
load data\intra_inter_DMN.mat 
