%**************************************************************************
% Description: demo for getting results of DMN in the submission
% Input: (1) mask_ind.mat: index for in-brain voxels, including mask_ind.
%        (2) sm_EBM_DMN.mat: saptial maps estimate for DMN by EBM with component 
%            selection, phase processing and best-run seletction,including half_ind and Sm.
%        (3) bs_DMN.mat: 1000 bootstrap samples for DMN, including bs_diff, bs_diff_FDR, bs_mag_diff and bs_mag_diff_FDR.
%        (4) intra_inter_DMN.mat: 1000 resampling results for intra- and inter- difference in DMN, 
...
% Output: variance difference of SZ-HC on spatial source phase and magnitude in DMN.
